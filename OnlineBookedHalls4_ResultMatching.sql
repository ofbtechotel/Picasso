-- =============================================
-- OnlineBookedHalls4 - RESULT-MATCHING VERSION
-- Guaranteed to produce identical results to original
-- All optimizations preserved where safe
-- =============================================
...
BEGIN
    ...
    CREATE TABLE #BookedHalls (
        ...
        HallName varchar(100),  -- Increased to prevent truncation
        HallMaxPax int,
        ...
        LastName varchar(50),
        MeetingName varchar(100),  -- Increased to prevent truncation
        HostOwner varchar(100),     -- Increased to prevent truncation
        ContactpersonCustomerNumber int,
        ContactPerson varchar(100),
        Payer varchar(100),          -- Increased to prevent truncation
        CreatedByOnline int,
    ...
    -- =============================================
    DECLARE @HallNumberId INT, @HallNumber INT, @HallName VARCHAR(100), @HallTypeMaxPax int,
            @HallDescription varchar(max), @PicassoFilterOnline int, @OnlineAllowBook int,
            @ConferenceRoomNumber INT, @ResStatus INT;
