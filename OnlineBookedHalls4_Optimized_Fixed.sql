-- =============================================
-- OPTIMIZED AND FIXED VERSION OF OnlineBookedHalls4
-- Fixed: NULL handling and primary key violations
-- =============================================
...
BEGIN
    ...
    -- Create temp table with NULLable datetime columns
    CREATE TABLE #BookedHalls (
        ...
        OnlineAllowBook int,
        ArrivalDate datetime NULL,  -- Changed to NULLable
        DepartureDate datetime NULL,  -- Changed to NULLable
        ReferenceNumber int,
        RoomLineNumber int,
        ...
        ResStatus int
        -- Removed PRIMARY KEY to avoid duplicate key issues
    );
    ...
    SELECT DISTINCT
        ...
        NULL AS ResStatus,
        NULL AS ArrivalDate,  -- Hall records have NULL dates
        NULL AS DepartureDate  -- Hall records have NULL dates
    ...
    -- =============================================
    -- 2. Get all bookings (with proper date handling)
    -- =============================================
    INSERT INTO #BookedHalls (
